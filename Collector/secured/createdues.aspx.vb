...
Public Class createdues
    ...
    Public Sub createDUES()
        ...
        drow("PaidDate") = TextBox7.Text 'store startdate for dues
        drow("ShowMeOnIndex") = Convert.ToBoolean(DropDownList4.SelectedValue)
        drow("Type") = "DUES"
        ...
        ClientScript.RegisterClientScriptBlock(Me.GetType(), "validation", "alert('Collection has been successfully created.');" + String.Format("window.location='../dues.aspx?collectionid={0}';", Session.Item("collectionhold").ToString), True)
    End Sub
