<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pay.aspx.vb" Inherits="Collector.pay" %>
                ...
                <div class="col-sm-9 col-md-9 col-lg-6 mx-auto">
                    ...
                    <div class="card card-signin    my-5 shadow">
                        <div class="card-header  bg-white border-bottom border-warning  ">
                            <h3 class="card-title text-center">Pay Dues</h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <p class="text-left">Dues for:</p>
                                    <h6 class=" ">
                                        <asp:Label ID="heyyyy" runat="server"></asp:Label>
                            ...
                            <div class="row ">
                                ...
                                <div class="col">
                                    <p class="text-left">Amount Per Month:</p>
                                    <h6 class="">
                                        <asp:Label ID="Label3" runat="server" Text="" CssClass="h6 text-dark"></asp:Label></h6>
                                </div>
                          
                            <div class="col">
                                    <p class="text-left">Open to:</p>
                                    <h6 class="">
                                        <asp:Label ID="Label1" runat="server" Text="" CssClass="h6 text-dark"></asp:Label></h6>
                                </div>    
                            </div>
                            <hr class="  bordercolorblue border-bottom" />
                     ...
                     <div class="input-group">
                                    <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" required="true" Placeholder="Enter Email Address or PhoneNumber"></asp:TextBox>
                         <div class="input-group-append">
                           
                             <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btncusblue"><i class="fa fa-search"></i> Search</asp:LinkButton>
                         </div>
                     </div>
                             <%--   <asp:CheckBox ID="CheckBox1" runat="server" Text="Show me as anonymous" CssClass="   p-3" AutoPostBack="true" />--%>
                                <asp:Label ID="Label2" runat="server" Text="" CssClass="p-3 small   companybluecolor" ></asp:Label>    
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <label id="selectmonth" runat="server" visible="false" class="small">Select Month</label>
                                    
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:kpolomDUMMYConnectionString %>' SelectCommand="SELECT * FROM [Dues_Log] WHERE (([DuesID] = @DuesID) AND ([userID] = @userID))">
                                        <SelectParameters>
                                            <asp:SessionParameter SessionField="collectionhold" Name="DuesID" Type="String"></asp:SessionParameter>
                                            <asp:SessionParameter SessionField="PID" Name="userID" Type="String"></asp:SessionParameter>
                                        </SelectParameters>
                                    </asp:SqlDataSource>

                                   <%-- <asp:DataList ID="DataList1" runat="server" DataKeyField="LogID" DataSourceID="SqlDataSource1" RepeatColumns="2" CssClass="table table-primary">
                                       <HeaderTemplate >
                                           <asp:CheckBox ID="CheckBox5" runat="server" Text="Select All" />
                                       </HeaderTemplate>
                                        <ItemTemplate>--%>
                                      <%--      <asp:CheckBox ID="CheckBox1" runat="server" Text="JAN 2022" />--%>
                                         <%--   Goal:--%>
                                        <%--    <asp:Label  runat="server" ID="GoalLabel" /><br />--%>
                                        <%--   <div class="form-check">
                                                <asp:CheckBox ID="CheckBox4" runat="server" Text='<%# Eval("PaymentMonth") %>' CssClass="" />
                                           </div>
                                        </ItemTemplate>
                                    </asp:DataList>--%>

                                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatColumns="2" RepeatDirection="Vertical" CssClass="table table-borderless small"  AutoPostBack="true" >
                                      <%--  <asp:ListItem>JAN 2022</asp:ListItem>
                                           <asp:ListItem>FEB 2022</asp:ListItem>
                                           <asp:ListItem>MAR 2022</asp:ListItem>--%>
                                    </asp:CheckBoxList>
                                  <%--  <asp:Button ID="Button2" runat="server" Text="looper" />--%>
                                </div>
                            </div>
                            <hr class="bordercolorblue border-bottom" />  
                                    <div class="form-group">
                                <label>Total Dues:</label>
                                <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control form-control-lg border   border-primary"  onkeyup="FormatCurrency(this);calccharge();" onkeypress="return CheckNumeric();" required="true" MaxLength="7" TextMode="Phone" ReadOnly="true" AutoPostBack="true"></asp:TextBox>
                            ...
                            <div class="row">
                             ...
                             <div class="form-group">
                                ...
                                <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" required="true"  MaxLength="11" onkeypress="return CheckNumeric();" TextMode="Phone"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                <asp:Button ID="Button1" runat="server" Text="Pay" CssClass="btn custombtn btn-block btn-lg"  Visible="false" />
