<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="Collector.index" %>
...
@media (min-width: 768px) {
    ...
    .carousel-inner .carousel-item-next {
      transform: translateX(25.333%); /*33.333%*/
    }
    
    .carousel-inner .carousel-item-start.active, 
    .carousel-inner .carousel-item-prev {
      transform: translateX(-25.333%);
    }
}
 ...
 <h2 class=" header2 colorawesomblue">Collect dues, raise funds to support your beloved causes.</h2>
       ...
       <div class="row mt-2">
        ...
        <div class="   col-lg-5"  >
               ...
               <img src="img/04.-Helping-SomeoneCOPY.png" class="img-fluid mt-lg-5 " />
...
<div class="container">
    ...
    <a href="#" class=""></a>
                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass=" btn custombtn-outline  w-100"><i class=" fas fa-hand-holding-heart"></i> Donate</asp:HyperLink>
            ...
            <a class="carousel-control-prev w-auto" href="#recipeCarousel" role="button" data-bs-slide="prev">
                <span class="carousel-control-prev-icon bg-dark border border-dark rounded-circle" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next w-auto" href="#recipeCarousel" role="button" data-bs-slide="next">
