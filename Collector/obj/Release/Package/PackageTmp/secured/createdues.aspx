<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/secured/Site1.Master" CodeBehind="createdues.aspx.vb" Inherits="Collector.createdues" ValidateRequest="false" %>
            ...
            <div class="col-md-8">
                <div class="card mt-4">
                    <div class="card-body">
                         ...
                         <h5 class="text-primary mylinottefamily my-2 borderwidth border-bottom border-primary ">Create Dues</h5>
                         <div class="form-group">
                            <small>Upload a banner image <b> (<i class="fa fa-info-circle colorawesomblue fa-1x"></i> Best Fit W:<=1,280px X H:<=720px)</b></small>
                        </div>
                        <center>
                      ...
                      <%--  checksize();--%>
                        ...
                        <div class="form-group">
                            <label>Purpose for Dues <small class="text-muted">e.g Dues for Our School Alumni</small> </label>
...
<div class="col-md">
    <div class="form-group">
                            ...
                            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control ">
                                ...
                                <asp:ListItem>Home Owners Association</asp:ListItem>
                            ...
                            <div class=" col-md">
                                <div class="form-group">
                                    <label>Contribution List <small>(who can join?)</small> </label>
                                      <asp:DropDownList ID="DropDownList4" runat="server" CssClass="form-control ">

                                <asp:ListItem Value="False">Anybody</asp:ListItem>
                                     <asp:ListItem Value="True">Members Only</asp:ListItem>
                            <%--    <asp:ListItem>Yearly</asp:ListItem>--%>
                                ...
                                <div class="row">
                                    <div class=" col-md">
                                <div class="form-group">
                                    <label>Start Date<small>(Dues start by this date)</small> </label>
                                    <asp:TextBox ID="TextBox7" runat="server" CssClass="form-control" TextMode="Month" required="true" onblur="return checkDate2();"></asp:TextBox>
                                </div>
                            </div>
                            <div class=" col-md">
                                <div class="form-group">
                                    <label>End Date<small>(Dues expires by this date)</small> </label>
                                    <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" TextMode="Month" required="true" onblur="return checkDate();"></asp:TextBox>
                                </div>
                            </div>
                            <div class=" col-md">
                                <div class="form-group">
                                    <label>Amount <small>(To be paid monthly)</small> </label>
                            ...
                            <div class="form-group">
                                <label>Description <small>(what people should know about this contribution)</small></label>
       ...
       Please confirm the account number or bank and try again.
                        ...
                        <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Create Dues" CssClass="btn btn-primary btn-lg btn-block" />
    ...
    <script type="text/javascript">
     ...
     <script>
         ...
         function checkDate() {
            ...
            if (enterDate < today) {
                alert("You need to select a due date that is later than today !");
         ...
         function checkDate2() {
             ...
             var today = new Date();
             var enterDate = document.getElementById('<%= TextBox7.ClientID %>').value;
            enterDate = new Date(enterDate)
            if (enterDate > today) {
                alert("You need to select a start date that is earlier than today !");
                  document.getElementById('<%= TextBox7.ClientID %>').value = new Date('2004-10-10');
